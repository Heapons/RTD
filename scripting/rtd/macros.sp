...
public void %1_Call(int client, const Perk perk, const bool apply, const RTDRemoveReason reason) \
{ \
	if(apply) \
	{ \
...
public void %1_Call(int client, const Perk perk, const bool apply) \
{ \
	if(apply) \
	{ \
		%1_ApplyPerk(client, perk); \
